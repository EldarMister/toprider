        ...
        <div onclick="showProduct(${product.id})" class="product-card cursor-pointer group bg-white flex flex-col">
            ...
            <div class="p-2 flex flex-col flex-1">
                ...
                <div class="mt-auto space-y-1.5">
                    ...
                    <a href="https://wa.me/996508708408?text=Здравствуйте, интересует ${encodeURIComponent(product.title)}" target="_blank" onclick="event.stopPropagation()" class="block bg-[#66CC33] hover:bg-[#57b32c] text-white font-bold py-1.5 px-1.5 rounded text-[9px] md:text-[10px] transition uppercase flex items-center justify-center gap-1 w-full">
